...
?>  
<html>
<title>Visitor Property Page</title>
<body>
...
<?php
    ...
    if(isset($_GET['UnLog'])){
		$UnLog = $_GET['UnLog'];
		$query7 = "DELETE FROM Visit WHERE Username='$username' AND PropertyID='$PropertyID'";
...
Rate Your Visit:
<?php
echo "<a href='visitor_property_logged.php?ID=".$PropertyID."&username=".$username."&rate=1'>1 </a></td>";
echo "<a href='visitor_property_logged.php?ID=".$PropertyID."&username=".$username."&rate=2'>2 </a></td>";
echo "<a href='visitor_property_logged.php?ID=".$PropertyID."&username=".$username."&rate=3'>3 </a></td>";
echo "<a href='visitor_property_logged.php?ID=".$PropertyID."&username=".$username."&rate=4'>4 </a></td>";
echo "<a href='visitor_property_logged.php?ID=".$PropertyID."&username=".$username."&rate=5'>5 </a></td>";
?>
<br><br><br>
</form>
</tr>
